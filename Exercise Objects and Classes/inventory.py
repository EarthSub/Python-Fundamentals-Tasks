...
# You can read more about private attributes here. Each inventory should also have an attribute called items - empty list,
# where all the items will be stored. The class should also have 3 methods:

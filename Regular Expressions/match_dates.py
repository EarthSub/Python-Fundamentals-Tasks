...
# · The separator must be the same for the whole date (e.g., 13.03.2016 is valid,
#     13.03/2016 is NOT). Use a group back reference to check for this.
...
#
# Now it is time to find all the valid dates in the input and print each date in the following format:
...
results = re.finditer(pattern, date)

...
# The input will be a string containing phone numbers and other symbols.
...
#     a combination of both (e.g., +359 2-111 111 has mixed delimiters, it is invalid). Use a group backreference to achieve this.
...
# +359-2-222-222, +359-2-222-22222 +359-2-222-222
...
result = re.findall(pattern, phones_numbers)
